...
--
-- Host: localhost
-- Generation Time: May 18, 2025 at 05:59 AM
...
CREATE TABLE `author` (
  ...
  `profile_picture` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'No-profile-picture.jpeg'
...
CREATE TABLE `blogs` (
  ...
  `image` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'other_resource/no-picture-book.jpg',
...
(1, 2, 'The Let Them Theory', 15, 1, 'The let them theory.jpg'),
(2, 2, 'The Day That Turns Your Life Around', 14, 1, 'The Day that Turns Your Life Around.jpg');
...
CREATE TABLE `publisher` (
  ...
  `profile_image` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'No-profile-picture.jpeg'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
